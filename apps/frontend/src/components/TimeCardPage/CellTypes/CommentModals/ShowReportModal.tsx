...
import { WarningIcon, AddIcon, DeleteIcon, EditIcon } from "@chakra-ui/icons";
...
const saveEditedReport = (
  ...
  setReports(
    getAllActiveCommentsOfType(CommentType.Report, [
      ...comments,
      newComment,
    ]) as ReportSchema[]
  );
  ...
  const AddReportModal = () => {
    ...
    const handleSubmit = (e) => {
      ...
      if (reports.filter((report) => report.Content === reason).length === 0) {
        setReports([
          ...reports,
          createNewReport(user, reason, notify, explanation),
        ]);
        toast({
        ...
        <ModalContent borderRadius="xl" maxW="500px">
          <VStack spacing={1}>
            <Box
              ...
              borderTopRadius="xl"
            >
              <ModalHeader textAlign="center" p={1} m={1}>
                {CommentType.Report}
              </ModalHeader>
            </Box>
            ...
            <Box p={4}>
              <form onSubmit={handleSubmit}>
                ...
                <FormControl mt={4}>
                  <FormLabel>
                    Did the associate notify the supervisor reasonably in
                    advance?
                  </FormLabel>
                ...
                <FormControl mt={4}>
                  <FormLabel>
                    Why did the associate arrive late/no show/leave early?
                  </FormLabel>
                  <InputGroup width="150px" borderRadius="2xl">
                    ...
                    />
                    <InputRightElement children={<EditIcon />} />
                  </InputGroup>
                </FormControl>
              </form>
            </Box>
            <ModalFooter>
              <HStack spacing={10}>
                <Button style={{ borderRadius: "15px" }} onClick={onCloseAdd}>
                  Close
                </Button>
                <Button
