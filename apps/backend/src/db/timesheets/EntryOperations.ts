...
export class frontendEntryConversions {
  ...
  private static hoursDataMappings = {
    Type: new KeyPairMappings(
      "Type",
      "Type",
      frontendEntryConversions.toDBType
    ),
    Associate: new KeyPairMappings(
      "Associate",
      "AssociateTimes",
      frontendEntryConversions.toDBRowEntry
    ),
    Supervisor: new KeyPairMappings(
      "Supervisor",
      "SupervisorTimes",
      frontendEntryConversions.toDBRowEntry
    ),
    Admin: new KeyPairMappings(
      "Admin",
      "AdminTimes",
      frontendEntryConversions.toDBRowEntry
    ),
    Comment: new KeyPairMappings(
      "Comment",
      "Note",
      frontendEntryConversions.toDBNotes
    ),
  };
  ...
  /*
    ...
    */
  public static insertConversion(
    body: requestSchemas.InsertRequest
  ): requestSchemas.InsertRequest {
    switch (body.Type) {
  ...
  /*
    ...
    */
  public static updateConversion(
    body: requestSchemas.UpdateRequest
  ): requestSchemas.UpdateRequest {
    switch (body.Type) {
      case requestSchemas.TimesheetListItems.TABLEDATA:
  ...
  /*
    ...
    */
  private static toDBRow(
    row: frontendRowTypes.RowSchema
  ): dbTimesheetTypes.TimesheetEntrySchema {
  ...
  private static toDBRowEntry(
    row: frontendRowTypes.TimeRowEntry | undefined
  ): dbTimesheetTypes.TimeEntrySchema | undefined {
    if (row !== undefined) {
  ...
  private static toDBType(
    entryType: frontendRowTypes.RowType
  ): dbTimesheetTypes.CellType {
    switch (entryType) {
  ...
  private static toDBNotes(
    comments: frontendRowTypes.CommentSchema[] | undefined
  ): dbTimesheetTypes.NoteSchema[] | undefined {
    if (comments !== undefined) {
      return comments.map((comment) =>
        frontendEntryConversions.toDBNote(comment)
      );
    }
    return undefined;
  }
  ...
  private static toDBSchedule(
    row: frontendRowTypes.ScheduledRowSchema
  ): dbTimesheetTypes.ScheduleEntrySchema {
