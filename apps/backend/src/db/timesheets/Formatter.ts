...
export class Formatter {
  ...
  public static format(
    timesheets: timesheetSchemas.TimeSheetSchema[]
  ): timesheetSchemas.TimeSheetSchema[] {
  ...
  private static validate(
    timesheet
  ): [timesheetSchemas.TimeSheetSchema, boolean] {
  ...
  private static ensureAllDays(
    timesheet: timesheetSchemas.TimeSheetSchema
  ): [timesheetSchemas.TimeSheetSchema, boolean] {
    /*
    ...
    const updatedRows = [];
    var endDate = moment
      .unix(timesheet.StartDate)
      .add(constants.TIMESHEET_DURATION - 1, "days");
  ...
  private static createEmptyRow(
    date: number
  ): timesheetSchemas.TimesheetEntrySchema {
