...
const availableListTypes = z.enum([TimesheetListItems.TABLEDATA, TimesheetListItems.WEEKNOTES])
...
/*
    The schema for an insert request for an item 
        @Type: The type of the item that we are inserting, to know what we should be adding this item to (Either weekly notes or timesheet data)
        @Item: The item we are inserting - either a timesheet row or a note for the week, depending on the type of the request
*/
